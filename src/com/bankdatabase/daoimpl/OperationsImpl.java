...
public class OperationsImpl implements Operations{
	...
	public void withdrawal(long acc_num) {
		...
		try {
			PreparedStatement preparedstatement=con.prepareStatement("update user set balance=(balance-?) where account_no=? and balance>?");
	...
	public void deposit(long acc_num) {
		...
		Connection con=d.connect();
		try {
			PreparedStatement preparedstatement=con.prepareStatement("update user set balance=(balance+?) where account_no=? ");
